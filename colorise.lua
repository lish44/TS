...
c.rgba2hex = function(rgb) return c.rgb2hex(rgb) end
...
--[[ex:
    ...
    nLog(color.hex2rgba("D2527FEE")) -- or '#D2527FEE'
  
    nLog(color.rgb2hex({210, 82, 127}))
   
    nLog(color.rgb2hex({210, 82, 127, 238}))
]] -- 
